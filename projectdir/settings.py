...
SECRET_KEY = 'o-_g^1@(j!((6pkc=ifm2f@l_&)gi-rb4)pq-*y%6+eojzo!gm'
...
MIDDLEWARE = [
    ...
    'projectdir.utils.CustomTimezoneMiddleware'
]
...
ASGI_APPLICATION = 'projectdir.routing.application'
...
EMAIL_HOST_PASSWORD = 'sjnpaoagjcmcrhfb'
EMAIL_PORT = 587
